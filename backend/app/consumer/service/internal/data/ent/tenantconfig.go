...
type TenantConfig struct {
	...
	// 配置类型
	ConfigType tenantconfig.ConfigType `json:"config_type,omitempty"`
	// 是否加密存储
...
func (*TenantConfig) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tenantconfig.FieldConfigKey, tenantconfig.FieldConfigValue, tenantconfig.FieldDescription, tenantconfig.FieldConfigType:
	...
	for i := range columns {
		...
		case tenantconfig.FieldConfigType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ConfigType = tenantconfig.ConfigType(value.String)
			}
...
func (_m *TenantConfig) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.ConfigType))
	builder.WriteString(", ")
