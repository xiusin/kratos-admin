...
const (
	...
	// FieldValidationRule holds the string denoting the validation_rule field in the database.
	FieldValidationRule = "validation_rule"
...
var (
	...
	// ValidationRuleValidator is a validator for the "validation_rule" field. It is called by the builders before save.
	ValidationRuleValidator func(string) error
...
// ByValidationRule orders the results by the validation_rule field.
func ByValidationRule(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldValidationRule, opts...).ToFunc()
}
