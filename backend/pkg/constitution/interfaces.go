...
// DocumentationSyncer synchronizes documentation with code changes
type DocumentationSyncer interface {
	// SyncAPIDocumentation synchronizes API documentation
	SyncAPIDocumentation(protoFile string) error

	// SyncComponentDocumentation synchronizes component documentation
	SyncComponentDocumentation(componentFile string) error

	// SyncFeatureDocumentation synchronizes feature documentation
