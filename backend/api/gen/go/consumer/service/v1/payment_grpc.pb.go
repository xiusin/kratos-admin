...
const (
	PaymentService_CreatePayment_FullMethodName      = "/consumer.service.v1.PaymentService/CreatePayment"
	PaymentService_GetPayment_FullMethodName         = "/consumer.service.v1.PaymentService/GetPayment"
	PaymentService_QueryPaymentStatus_FullMethodName = "/consumer.service.v1.PaymentService/QueryPaymentStatus"
	PaymentService_Refund_FullMethodName             = "/consumer.service.v1.PaymentService/Refund"
	PaymentService_QueryRefundStatus_FullMethodName  = "/consumer.service.v1.PaymentService/QueryRefundStatus"
	PaymentService_ListPayments_FullMethodName       = "/consumer.service.v1.PaymentService/ListPayments"
)
...
type PaymentServiceClient interface {
	...
	// 查询支付订单
	GetPayment(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentOrder, error)
	// 查询支付结果
	QueryPaymentStatus(ctx context.Context, in *QueryPaymentStatusRequest, opts ...grpc.CallOption) (*PaymentStatusResponse, error)
	// 申请退款
	Refund(ctx context.Context, in *RefundRequest, opts ...grpc.CallOption) (*RefundResponse, error)
	// 查询退款状态
	QueryRefundStatus(ctx context.Context, in *QueryRefundStatusRequest, opts ...grpc.CallOption) (*RefundStatusResponse, error)
	// 查询支付流水
	ListPayments(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*ListPaymentsResponse, error)
}
...
func (c *paymentServiceClient) GetPayment(ctx context.Context, in *GetPaymentRequest, opts ...grpc.CallOption) (*PaymentOrder, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) QueryPaymentStatus(ctx context.Context, in *QueryPaymentStatusRequest, opts ...grpc.CallOption) (*PaymentStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) QueryRefundStatus(ctx context.Context, in *QueryRefundStatusRequest, opts ...grpc.CallOption) (*RefundStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RefundStatusResponse)
	err := c.cc.Invoke(ctx, PaymentService_QueryRefundStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) ListPayments(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*ListPaymentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	...
	// 查询支付订单
	GetPayment(context.Context, *GetPaymentRequest) (*PaymentOrder, error)
	// 查询支付结果
	QueryPaymentStatus(context.Context, *QueryPaymentStatusRequest) (*PaymentStatusResponse, error)
	// 申请退款
	Refund(context.Context, *RefundRequest) (*RefundResponse, error)
	// 查询退款状态
	QueryRefundStatus(context.Context, *QueryRefundStatusRequest) (*RefundStatusResponse, error)
	// 查询支付流水
	ListPayments(context.Context, *v1.PagingRequest) (*ListPaymentsResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPayment(context.Context, *GetPaymentRequest) (*PaymentOrder, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPayment not implemented")
}
func (UnimplementedPaymentServiceServer) QueryPaymentStatus(context.Context, *QueryPaymentStatusRequest) (*PaymentStatusResponse, error) {
...
func (UnimplementedPaymentServiceServer) QueryRefundStatus(context.Context, *QueryRefundStatusRequest) (*RefundStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryRefundStatus not implemented")
}
func (UnimplementedPaymentServiceServer) ListPayments(context.Context, *v1.PagingRequest) (*ListPaymentsResponse, error) {
...
func _PaymentService_QueryRefundStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryRefundStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).QueryRefundStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_QueryRefundStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).QueryRefundStatus(ctx, req.(*QueryRefundStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_ListPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ListPayments(ctx, req.(*v1.PagingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "consumer.service.v1.PaymentService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PaymentService_QueryRefundStatus_Handler,
		},
		{
	...
	Metadata: "consumer/service/v1/payment.proto",
}
